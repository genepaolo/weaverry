...
import img2 from "../../resources/Icons/icons8-css3-96.png";
...
import img4 from "../../resources/Icons/icons8-google-96.png";
import img5 from "../../resources/Icons/icons8-html-5-96.png";
import img6 from "../../resources/Icons/icons8-javascript-logo-96.png";
import img7 from "../../resources/Icons/icons8-mongodb-a-cross-platform-document-oriented-database-program-96.png";
import img8 from "../../resources/Icons/icons8-react-96.png";
function Tech(){
    const tech = [img1,img2,img3,img4,img5,img6,img7,img8];
    const techName = ["AWS","CSS","Firebase","GCP","HTML","JavaScript","MongoDB","React"];
    return(
